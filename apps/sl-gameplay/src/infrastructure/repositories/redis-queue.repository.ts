...
@Injectable()
export class SLRedisMatchingQueueService implements SLMatchingQueueService {
  private readonly logger = new Logger(SLRedisMatchingQueueService.name);
